...
# -*- coding: utf-8 -*-
#
# Curso Introdutório de Python documentation build configuration file, created by
# sphinx-quickstart on Sat Jun 24 21:03:14 2017.
#
...
latex_documents = [
    (master_doc, 'CursoIntrodutriodePython.tex', 'Curso Introdutório de Python Documentation',
     'Grupy-Sanca', 'manual'),
]
