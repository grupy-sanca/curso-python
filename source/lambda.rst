...
A função lambda tem origem no lambda cálculo, originalmente desenvolvido pelo matemático Alonzo Church. 
Como função no Python seu uso permite que a criação rápida de funções sem que seja necessário nomea-las. 

No python tem a forma: 
